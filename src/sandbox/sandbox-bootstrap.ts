...
/**
 * Bootstrap for module execution mode (NPM imports via esm.sh).
 * Same console interception and error handling, but:
 * - No postMessage("ready") handshake (code is inline in srcdoc)
 * - No message listener for "run" (code runs as <script type="module">)
 */
export const SANDBOX_BOOTSTRAP_MODULE = `
(function() {
  var _timers = {};
